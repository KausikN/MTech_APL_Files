...
public :
  ...
  {
    Complex Value;
    Value.real = this->real + num.real;
    Value.imag = this->imag + num.imag;
    //return(*this);
    return(Value);
    }
  ...
  */
  ...
  {
    Complex Value;
    Value.real = this->real*num.real - this->imag*num.imag;
    Value.imag = this->imag*num.real + this->real*num.imag;
    return(Value);
  }
  Complex operator/ (Complex num) 
  {
